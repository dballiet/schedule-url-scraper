...
import { VerifyCsv } from '@/components/VerifyCsv';
import { AGE_GROUPS, AgeGroup } from '@/lib/types';
import { Play, Upload, Download, FileCheck, Search, CheckCircle } from 'lucide-react';
import { cn } from '@/lib/utils';

type TabMode = 'scrape' | 'verify';
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">
            {activeTab === 'scrape'
              ? 'Select associations, optionally upload a master CSV for comparison, and scrape team calendars.'
              : 'Upload an extracted CSV to verify that calendar URLs have current events.'}
          </p>
        </div>
